...
export default function RegisterPage() {
  ...
  const [form, setForm] = useState({ username: '', email: '', password: '', confirm: '', phone: '', school: '' });
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h2 className="mt-6 text-2xl font-bold text-gray-900">注册账户</h2>
          <p className="mt-2 text-sm text-gray-600">
            已有账户？ <Link href="/login" className="text-blue-600 hover:text-blue-700">立即登录</Link>
          </p>
        </div>
